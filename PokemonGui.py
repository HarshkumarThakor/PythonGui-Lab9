...
# Setting display size            
    ...
    root.iconbitmap(os.path.join(script_dir, 'Poke-Ball.ico')) #Pokeball icon
...
# Fetching image of pokeball    
    img_pokemon = PhotoImage(file=os.path.join(script_dir,'Pokeball-PNG-Clipart.png'))   # Fetch pokeball png image
 ...
 # This code is used to download and save image
